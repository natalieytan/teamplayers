...
ActiveRecord::Schema.define(version: 20180510062404) do
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.decimal "latitude"
    t.decimal "longitude"
    t.index ["gender_id"], name: "index_games_on_gender_id"
    t.index ["skill_id"], name: "index_games_on_skill_id"
  ...
  add_foreign_key "games", "genders"
  add_foreign_key "games", "skills"
